...
public class Constants {
	...
	public static int DEFAULT_TRAIN_SECTION_SEAT_COUNT = 50;

	public enum ErrorCode{
		SERVER_ERROR(500, "Technical issues at the moment"), 
		UNABLE_MODIFY_TICKET(1000, "Unable to modify the ticket for the user. Already someone occuppied this ticket"),
